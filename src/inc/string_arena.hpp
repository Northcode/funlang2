...
struct arena_page
{
    ...
    bool is_head(mystr s) { return s.data == data + current_head; }
...
struct arena
{
    ...
    void discard_head() { pages.back().discard_head(); }

    bool is_head(mystr s) { return pages.back().is_head(s); }
